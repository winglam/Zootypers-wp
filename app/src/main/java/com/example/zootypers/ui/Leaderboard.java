...
/**
 * Controls all of the action happening in the Leaderboard UI, switching tabs, populating the leaderboard, etc
 *
 * @author ZooTypers
 */
@SuppressLint("NewApi")
public class Leaderboard extends FragmentActivity {
     ...
     *
     * @param dismisspsw If the password popup is currently being displayed (and therefore should be dismissed)
     */
