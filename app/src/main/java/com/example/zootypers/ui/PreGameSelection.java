...
public class PreGameSelection extends Activity {
    ...
    /**
     * When continue is clicked, goes to the game play screen. Passes id of animal & background button selected and an
     * int coding of difficulty, where 1 is easy, 2 is medium, and 3 is hard.
     *
    ...
    /**
     * When the user clicks a button to select a difficulty, highlights that button and un-highlights the last selected
     * button.
     *
     * @param view The button clicked
     */
    ...
    /**
     * When the user clicks a button to select an animal, highlights that button and un-highlights the last selected
     * button.
     *
     * @param view The button clicked
     */
    ...
    /**
     * When the user clicks a button to select a background, highlights that button and un-highlights the last selected
     * button.
     *
     * @param view The button clicked
     */
