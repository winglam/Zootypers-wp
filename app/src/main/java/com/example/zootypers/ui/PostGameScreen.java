...
public class PostGameScreen extends Activity {
    ...
    /**
     * Helper method to build a popup screen for the save score popup
     */
    ...
    /**
     * Called when the user wants to exit out of the save name popup
     *
    ...
    /**
     * Called when the user clicks the "Submit" button when a name is typed in
     *
     * @param view the button that is clicked
     */
