...
/**
 * The abstract class for a Player that stores a list of words for the UI to display. It keeps track of word and letter
 * the user has typed and updates the view accordingly.
 *
...
public abstract class PlayerModel extends Observable {
    ...
    /**
     * The populateDisplayedList method gets called once by MultiPlayer after it added itself as an observer of this
     * class. The method populates the displayed word list with numWordsDisplayed amount of words.
     */
    ...
    /**
     * @return the string representation of the current word the player is locked to, null if player is not locked to a
     * word
     */
    ...
    /**
     * checks if the remaining words being displayed has the same first letter as the first letter of the potential next
