...
/**
 * The Model class for Single Player store a list of words for the UI to display. It keeps track of word and letter the
...
public class SinglePlayerModel extends PlayerModel {
     ...
     * @param am,       the asset manager of the SinglePlayer that gives the model to access to the words stored in the
     *                  asset folder
